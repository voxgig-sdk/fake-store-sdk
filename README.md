...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/fake-store` | `npm install @voxgig-sdk/fake-store` |
| Python | `voxgig-sdk-fake-store` | `pip install voxgig-sdk-fake-store` |
| PHP | `voxgig-sdk/fake-store` | `composer require voxgig-sdk/fake-store` |
| Golang | `github.com/voxgig-sdk/fake-store-sdk/go` | `go get github.com/voxgig-sdk/fake-store-sdk/go` |
| Ruby | `voxgig-sdk-fake-store` | `gem install voxgig-sdk-fake-store` |
| Lua | `voxgig-sdk-fake-store` | `luarocks install voxgig-sdk-fake-store` |
