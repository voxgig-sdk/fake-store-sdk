...
class CartEntity extends FakeStoreEntityBase<Cart> {
  ...
  async create(this: any, reqdata?: CartCreateData, ctrl?: Control): Promise<CartEntity> {
  ...
  async update(this: any, reqdata?: CartUpdateData, ctrl?: Control): Promise<CartEntity> {
  ...
  async remove(
    this: any, reqmatch?: CartRemoveMatch, ctrl?: Control,
  ): Promise<CartEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CartEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
