...
(0, node_test_1.describe)('UserDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FakeStoreSDK({
...
function liveScenariosActive() { return false && process.env.FAKE_STORE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'FAKE_STORE_TEST_USER_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.FakeStoreSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FAKE_STORE_TEST_USER_ENTID'];
    ...
    const client = new __1.FakeStoreSDK({
        base: 'http://localhost:8080',
