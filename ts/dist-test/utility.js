...
function envOverride(m) {
    if ('TRUE' === process.env.FAKE_STORE_TEST_LIVE ||
        'TRUE' === process.env.FAKE_STORE_TEST_OVERRIDE) {
    ...
    m.FAKE_STORE_TEST_EXPLAIN = process.env.FAKE_STORE_TEST_EXPLAIN || m.FAKE_STORE_TEST_EXPLAIN;
    return m;
}
