...
func (sdk *FakeStoreSDK) OptionsMap() map[string]any {
...
func (sdk *FakeStoreSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FakeStoreSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FakeStoreSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FakeStoreSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FakeStoreSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FakeStoreSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FakeStoreSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FakeStoreSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FakeStoreSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FakeStoreSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
