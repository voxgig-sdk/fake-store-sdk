...
const testSeed = `map[string]any{"entity": map[string]any{"cart": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "login": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
