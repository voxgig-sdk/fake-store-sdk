...
module FakeStoreTestRunner
  ...
  def self.env_override(m)
    live = getenv("FAKESTORE_TEST_LIVE")
    override = getenv("FAKESTORE_TEST_OVERRIDE")
    ...
    explain = getenv("FAKESTORE_TEST_EXPLAIN")
    m["FAKESTORE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
