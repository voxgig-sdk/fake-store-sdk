...
module FakeStoreTestRunner
  ...
  def self.env_override(m)
    live = getenv("FAKE_STORE_TEST_LIVE")
    override = getenv("FAKE_STORE_TEST_OVERRIDE")
    ...
    explain = getenv("FAKE_STORE_TEST_EXPLAIN")
    m["FAKE_STORE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = FakeStoreTestRunner
Helpers = FakeStoreHelpers
Vs = VoxgigStruct
