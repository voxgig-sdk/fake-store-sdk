...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cart | login | product | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FakeStoreSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fake-store_list",
		Description: "List records from FakeStore. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fake-store_load",
		Description: "Load a single record from FakeStore. " +
...
func runOp(client *sdk.FakeStoreSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FakeStoreSDK, name string) (sdk.FakeStoreEntity, error) {
