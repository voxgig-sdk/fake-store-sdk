...
// FakeStore SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FakeStoreOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FakeStoreOmni::structfix($now, Struct::undef()))
                        !== json_encode(FakeStoreOmni::structfix($val, Struct::undef()))) {
