...
class FakeStoreTestRunner
{
    ...
    {
        $live = self::getenv('FAKE_STORE_TEST_LIVE');
        $override = self::getenv('FAKE_STORE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FAKE_STORE_TEST_EXPLAIN');
...
class_alias('FakeStoreTestRunner', 'Runner');
class_alias('FakeStoreHelpers', 'Helpers');
