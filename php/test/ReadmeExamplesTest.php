...
// FakeStore SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FakeStoreSDK::test)
...
{
    private const SDK_CLASS = 'FakeStoreSDK';
    ...
    private const SDK_BASE = 'fakestore_sdk';
