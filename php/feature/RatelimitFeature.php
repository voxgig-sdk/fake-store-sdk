...
// FakeStore SDK ratelimit feature
...
class FakeStoreRatelimitFeature extends FakeStoreBaseFeature
{
    ...
    private function _acquire(FakeStoreContext $ctx): void
    {
    ...
    private function _track(FakeStoreContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
