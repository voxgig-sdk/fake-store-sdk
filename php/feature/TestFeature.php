...
// FakeStore SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FakeStoreTestFeature extends FakeStoreBaseFeature
{
    ...
    public function init(FakeStoreContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FakeStoreContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FakeStoreParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FakeStoreContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FakeStoreContext $ctx, $op, $args): array
    {
