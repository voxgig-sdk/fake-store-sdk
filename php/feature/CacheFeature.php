...
class FakeStoreCacheFeature extends FakeStoreBaseFeature
{
    ...
    private function _through(FakeStoreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
