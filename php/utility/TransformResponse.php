...
// FakeStore SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FakeStoreTransformResponse
{
    public static function call(FakeStoreContext $ctx): mixed
    {
        ...
        $transform = FakeStoreHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
