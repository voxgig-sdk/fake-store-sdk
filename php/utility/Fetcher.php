...
// FakeStore SDK utility: fetcher

class FakeStoreFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FakeStoreSDK/1.0)';
    ...
    public static function call(FakeStoreContext $ctx, string $fullurl, array $fetchdef): array
    {
