...
func registerSDKWords(r *eng.Registry, client *sdk.FakeStoreSDK) {
...
func runOp(client *sdk.FakeStoreSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
