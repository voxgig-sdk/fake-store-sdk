...
class FakeStoreTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeStoreTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FakeStoreTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FakeStoreTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
