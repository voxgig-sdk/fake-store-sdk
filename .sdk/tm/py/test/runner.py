...
class FakeStoreTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeStoreTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FakeStoreTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FakeStoreTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
