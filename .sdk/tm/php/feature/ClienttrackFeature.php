...
// FakeStore SDK clienttrack feature
...
class FakeStoreClienttrackFeature extends FakeStoreBaseFeature
{
    ...
    public function PostConstruct(FakeStoreContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FakeStore-SDK';
