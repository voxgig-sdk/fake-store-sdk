...
class FakeStoreProxyFeature extends FakeStoreBaseFeature
{
    ...
    public function init(FakeStoreContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FakeStoreContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
