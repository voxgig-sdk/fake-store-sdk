...
class FakeStoreTimeoutFeature extends FakeStoreBaseFeature
{
    ...
    private function _with_timeout(FakeStoreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FakeStoreContext $_ctx, float $ms): void
    {
        $client = $this->client;
