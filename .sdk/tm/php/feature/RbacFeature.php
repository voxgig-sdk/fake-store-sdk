...
class FakeStoreRbacFeature extends FakeStoreBaseFeature
{
    ...
    private function _required(FakeStoreContext $ctx): ?string
    {
    ...
    private function _reject(FakeStoreContext $ctx, string $required): void
    {
    ...
    private function _track(FakeStoreContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
