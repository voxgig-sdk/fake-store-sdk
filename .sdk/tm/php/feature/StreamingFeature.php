...
// FakeStore SDK streaming feature
...
class FakeStoreStreamingFeature extends FakeStoreBaseFeature
{
    ...
    private function _iterate(FakeStoreResult $result): \Generator
    {
    ...
    private function _streamable(FakeStoreContext $ctx): bool
    {
