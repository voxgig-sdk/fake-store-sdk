...
class FakeStoreGraphql
{
    ...
    // equivalent.
    public static function body(FakeStoreContext $ctx): mixed
    {
    ...
    public static function errors(FakeStoreContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
