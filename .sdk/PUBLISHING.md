...
|---|---|---|
| `ts/` | @voxgig-sdk/fake-store-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fake-store-sdk \
      --repository voxgig-sdk/fake-store-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fake-store-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fake-store-sdk --id=<id>` removes it.
