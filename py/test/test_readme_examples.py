# FakeStore SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FakeStoreSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FakeStoreSDK(...) and FakeStoreSDK.test(...) become
#      FakeStoreSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fakestore_sdk"
_SDK_CLASS = "FakeStoreSDK"
