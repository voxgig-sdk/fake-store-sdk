...
class FakeStoreTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeStoreTestRunner.getenv("FAKESTORE_TEST_LIVE")
        override = FakeStoreTestRunner.getenv("FAKESTORE_TEST_OVERRIDE")
        ...
        explain = FakeStoreTestRunner.getenv("FAKESTORE_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["FAKESTORE_TEST_EXPLAIN"] = explain
