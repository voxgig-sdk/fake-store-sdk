...
from fakestore_sdk.utility import register

# Load features
from fakestore_sdk.feature.base_feature import FakeStoreBaseFeature
from fakestore_sdk.features import _has_feature, _make_feature
...
class FakeStoreSDK:
    ...
    def get_utility(self):
        return FakeStoreUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FakeStoreSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Product(self, data=None) -> "ProductEntity":
        ...
        from fakestore_sdk.entity.product_entity import ProductEntity
        return ProductEntity(self, data)


    def User(self, data=None) -> "UserEntity":
        """Entity factory: client.User().list() / client.User().load({"id": ...})."""
        from fakestore_sdk.entity.user_entity import UserEntity
