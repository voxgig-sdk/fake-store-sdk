...
describe("CartEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FAKE_STORE_TEST_CART_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    cart_ref01_data = helpers.to_map(type(cart_ref01_data_result) == 'table' and cart_ref01_data_result.data_get and cart_ref01_data_result:data_get() or cart_ref01_data_result)
    ...
    assert.is_nil(err)
    local cart_ref01_resdata_up0 = helpers.to_map(type(cart_ref01_resdata_up0_result) == 'table' and cart_ref01_resdata_up0_result.data_get and cart_ref01_resdata_up0_result:data_get() or cart_ref01_resdata_up0_result)
...
function cart_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FAKE_STORE_TEST_CART_ENTID")
  ...
  if env["FAKE_STORE_TEST_LIVE"] == "TRUE" then
