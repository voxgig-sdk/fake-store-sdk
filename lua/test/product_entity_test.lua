...
describe("ProductEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FAKE_STORE_TEST_PRODUCT_ENTID JSON to run live")
      return
    end
    ...
    local product_ref01_markdef_up0_name = "category"
...
function product_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FAKE_STORE_TEST_PRODUCT_ENTID")
